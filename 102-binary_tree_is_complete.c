 ...
 *  We will get the number of nodes.
 *
 * Time Complexity: O(n)
 */
 ...
 *
 *  If the root is NULL, return 0.
 *  If the index is greater than or equal to the number of nodes, return 0.
 *  If the root is a leaf node, return 1.
 * If the root has a right child but no left child, return 0.
 *
 *  If the root has a left child but no right child,
