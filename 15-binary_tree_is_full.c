 ...
 * If the tree is not empty, check if the left
 * and right subtrees are full.
 *
 *  the left and right subtrees are full,
 * check if the left and right subtrees are empty.
 *
 * If the left and right subtrees are empty, return 1.
 *If the left and right subtrees are not empty, return 0.
 *
 * Time Complexity: O(n)
 */
 ...
 * If the tree is not empty, call the recursive function is_full_recursive()
 * to check if the tree is full.
 *
 * The recursive function is_full_recursive() returns 1
