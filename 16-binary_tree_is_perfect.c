 ...
 * FUNCTIONALITY *
 *
 * It’s checking if the node is NULL. If it is, it returns 0.
 *
 * If the node is not NULL, it checks if the node is a leaf.
 * If it is, it returns 1.
 *
 * If the node is not a leaf, it returns 0.
 *
 */
 ...
 *  If the tree is not NULL, return 1 + the depth of the parent.
 *
 */
size_t depth(const binary_tree_t *tree)
{
 ...
 * FUNCTIONALITY *
 *
 * If the tree is a leaf, return the tree.
 *
 * If the tree is not a leaf, return the left subtree if it exists,
 ...
 * FUNCTIONALITY *
 *
 * If the tree is a leaf, return 1 if the current level is
 * the same as the leaf depth, otherwise return 0.
 *
 * If the tree is not a leaf, but one of its children is missing, return 0.
