 ...
 */
/*
1. creating a 2D array of strings.
2. calling the print_t function to print the tree.
3. printing the 2D array of strings.
*/
/*
Time Complexity: O(n)
*/
...
/*
1. creating a 2D array of strings.
2. calling a function print_t to fill the 2D array with the tree’s values.
